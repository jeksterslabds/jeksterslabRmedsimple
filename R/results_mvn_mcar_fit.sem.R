#' Results: Fit Simple Mediation Model for Data Generated from a Multivariate Normal Distribution with Data Missing Completely at Random - Structural Equation Modeling
#'
#' @family results
#' @keywords results
#' @inherit A details
