...
#' mvn_std_pb.mvn(data = data, taskid = taskid)
#' @export
mvn_std_pb.mvn <- function(data,
                           taskid) {
...
#' @export
mvn_std_pb.mvn_task <- function(taskid,
                                dir = getwd(),
                                overwrite = FALSE) {
...
#' @export
mvn_std_pb.mvn_simulation <- function(dir = getwd(),
                                      all = TRUE,
                                      taskid = NULL,
                                      overwrite = FALSE,
                                      par = TRUE,
...
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pb.mvn_pcci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           par = TRUE,
                                           ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_std_pb.mvn_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pb.mvn_bcci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           par = TRUE,
                                           ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_std_pb.mvn_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @author Ivan Jacob Agaloos Pesigan
#'
#' @title Parametric Bootstrap Bias-Corrected and Accelerated Confidence Intervals for Indirect Effect in a Standardized Simple Mediation Model
#'   for Data Generated from a Multivariate Normal Distribution
#'   (Single Task)
#'
#' @family parametric functions
...
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pb.mvn_bcaci_simulation <- function(dir = getwd(),
                                            all = TRUE,
                                            taskid = NULL,
                                            par = TRUE,
                                            ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_std_pb.mvn_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
