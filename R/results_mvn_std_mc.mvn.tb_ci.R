#' Monte Carlo Simulation Results - Monte Carlo Method Confidence Intervals with Text Book Standard Errors for Standardized Indirect Effect (Multivariate Normal with Complete Data)
#'
