...
#' mvn_dat_mar_30(data = data, taskid = taskid)
#' @export
mvn_dat_mar_30 <- function(data,
                           taskid) {
...
#' @family multivariate normal data functions
#' @keywords mvn
#' @inheritParams mvn_dat_mar_30
#' @inheritParams mvn_dat_task
#' @export
mvn_dat_mar_30_task <- function(taskid,
                                dir = getwd(),
                                overwrite = FALSE) {
...
#' @inheritParams mvn_dat_mar_30_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_dat_mar_30_simulation <- function(dir = getwd(),
                                      all = TRUE,
                                      taskid = NULL,
                                      overwrite = FALSE,
                                      par = TRUE,
