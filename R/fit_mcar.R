...
#' mvn_fitfiml_mcar(data = data, taskid = taskid)
#' @export
mvn_fitfiml_mcar <- function(data,
                             taskid) {
...
#' @family model fit functions
#' @keywords fit
#' @inheritParams mvn_fitfiml_mcar
#' @inheritParams mvn_dat_task
#' @export
mvn_fitfiml_mcar_task <- function(taskid,
                                  dir = getwd(),
                                  overwrite = FALSE) {
...
#' @inheritParams mvn_fitfiml_mcar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_fitfiml_mcar_simulation <- function(dir = getwd(),
                                        all = TRUE,
                                        taskid = NULL,
                                        overwrite = FALSE,
                                        par = TRUE,
