...
#' vm_sev_pb.mvn(data = data, taskid = taskid)
#' @export
vm_sev_pb.mvn <- function(data,
                          taskid) {
...
#' @family parametric functions
#' @keywords pb
#' @inheritParams vm_sev_pb.mvn
#' @inheritParams mvn_fit.ols_task
#' @export
vm_sev_pb.mvn_task <- function(taskid,
                               dir = getwd(),
                               overwrite = FALSE) {
...
#' @inheritParams vm_sev_pb.mvn_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_pb.mvn_simulation <- function(dir = getwd(),
                                     all = TRUE,
                                     taskid = NULL,
                                     overwrite = FALSE,
                                     par = TRUE,
...
#' @export
vm_sev_pb.mvn_pcci_task <- function(taskid,
                                    dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_pb.mvn_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_pb.mvn_pcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          par = TRUE,
                                          ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_pb.mvn_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams vm_sev_dat_task
#' @export
vm_sev_pb.mvn_bcci_task <- function(taskid,
                                    dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_pb.mvn_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_pb.mvn_bcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          par = TRUE,
                                          ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_pb.mvn_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams vm_sev_dat_task
#' @export
vm_sev_pb.mvn_bcaci_task <- function(taskid,
                                     dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_pb.mvn_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_pb.mvn_bcaci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           par = TRUE,
                                           ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_pb.mvn_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
