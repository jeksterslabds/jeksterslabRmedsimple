...
#'
#' @title Nonparametric Bootstrap Estimates of Indirect Effect in a Simple Mediation Model for Data Generated Using the Vale and Maurelli (1983) Approach (Skewness = 3, Kurtosis = 21)
#'
...
#' vm_sev_std_nb(data = data, taskid = taskid)
#' @export
vm_sev_std_nb <- function(data,
                          taskid) {
...
#' @family nonparametric functions
#' @keywords nb
#' @inheritParams vm_sev_std_nb
#' @inheritParams mvn_fit.ols_task
#' @export
vm_sev_std_nb_task <- function(taskid,
                               dir = getwd(),
                               overwrite = FALSE) {
...
#' @inheritParams vm_sev_std_nb_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_std_nb_simulation <- function(dir = getwd(),
                                     all = TRUE,
                                     taskid = NULL,
                                     overwrite = FALSE,
                                     par = TRUE,
...
#' @export
vm_sev_std_nb_pcci_task <- function(taskid,
                                    dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_std_nb_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_std_nb_pcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          par = TRUE,
                                          ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_std_nb_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams vm_sev_dat_task
#' @export
vm_sev_std_nb_bcci_task <- function(taskid,
                                    dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_std_nb_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_std_nb_bcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          par = TRUE,
                                          ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_std_nb_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams vm_sev_dat_task
#' @export
vm_sev_std_nb_bcaci_task <- function(taskid,
                                     dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_sev_std_nb_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_std_nb_bcaci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           par = TRUE,
                                           ncores = NULL,
  ...
  fn <- "summary_medsimple_vm_sev_std_nb_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
