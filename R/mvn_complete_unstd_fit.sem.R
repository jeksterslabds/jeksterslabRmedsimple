...
#' mvn_fit.sem(data = data, taskid = taskid)
#' mvn_fit.ols(data = data, taskid = taskid)
#' @export
mvn_fit.sem <- function(data,
                        taskid) {
...
#' @family model fit functions
#' @keywords mvn_complete_std
#' @inheritParams mvn_fit.sem
#' @inheritParams mvn_dat_task
#' @export
mvn_fit.sem_task <- function(taskid,
                             dir = getwd(),
                             overwrite = FALSE) {
...
#' @inheritParams mvn_fit.sem_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_fit.sem_simulation <- function(dir = getwd(),
                                   all = TRUE,
                                   taskid = NULL,
                                   overwrite = FALSE,
                                   par = TRUE,
...
#' @export
mvn_fit.sem_task_summary <- function(taskid,
                                     dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @family model fit functions
#' @keywords mvn_complete_std
#' @inheritParams mvn_fit.sem_simulation
#' @inheritParams mvn_dat_simulation
#' @export
mvn_fit.sem_simulation_summary <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           par = TRUE,
                                           ncores = NULL,
  ...
  saveRDS(
    ...
    file = file.path(
      dir,
      "summary_medsimple_mvn_complete_fit.sem.Rds"
    )
  )
}
