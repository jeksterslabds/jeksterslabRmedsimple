...
#' mvn_dat_mar(data = data, taskid = taskid)
#' @export
...
#' @family multivariate normal data functions
#' @keywords mvn
#' @inheritParams mvn_dat_mar
#' @inheritParams mvn_dat_task
#' @export
mvn_dat_mar_task <- function(taskid,
                             dir = getwd(),
                             overwrite = FALSE) {
...
#' @inheritParams mvn_dat_mar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_dat_mar_simulation <- function(dir = getwd(),
                                   all = TRUE,
                                   taskid = NULL,
                                   overwrite = FALSE,
                                   par = TRUE,
