...
#' }
#' @examples
#' data(paramsmvn, package = "jeksterslabRmedsimple")
#' head(paramsmvn)
#' str(paramsmvn)
"paramsmvn"

#' Monte Carlo Simulation Parameters (Exponential)
#'
#' @family parameters functions
#' @keywords parameters
#' @inherit A details
...
#' Monte Carlo Simulation Parameters (Poisson)
#'
#' @family parameters functions
#' @keywords parameters
#' @inherit A details
...
#' }
#' @examples
#' data(paramspois, package = "jeksterslabRmedsimple")
#' head(paramspois)
#' str(paramspois)
"paramspois"
