...
#' mvn_std_jack(data = data, taskid = taskid)
#' @export
mvn_std_jack <- function(data,
                         taskid) {
...
#' @export
mvn_std_jack_task <- function(taskid,
                              dir = getwd(),
                              overwrite = FALSE) {
...
#' @export
mvn_std_jack_simulation <- function(dir = getwd(),
                                    all = TRUE,
                                    taskid = NULL,
                                    overwrite = FALSE,
                                    par = TRUE,
