...
#' system.time(mvn_mcar_nb_fiml(data = data, taskid = taskid))
#' }
#' @export
mvn_mcar_nb_fiml <- function(data,
                             taskid) {
  paramsmvn <- useparamsmvn(taskid = taskid)
  out <- nb(
    data = data,
    std = FALSE, # always FALSE for unstandardized coefficients
    complete = FALSE, # always FALSE for FIML
  ...
  attributes(out)$thetahat <- fit.sem(
    ...
    minimal = TRUE,
    std = FALSE, # always FALSE for unstandardized coefficients
    fiml = TRUE # always TRUE for FIML
  )
  out
}
...
#' @family nonparametric functions
#' @keywords mvn_complete_unstd
#' @inheritParams mvn_mcar_nb_fiml
#' @inheritParams mvn_fit.ols_task
#' @export
mvn_mcar_nb_fiml_task <- function(taskid,
                                  dir = getwd(),
                                  overwrite = FALSE) {
...
#' @inheritParams mvn_mcar_nb_fiml_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_nb_fiml_simulation <- function(dir = getwd(),
                                        all = TRUE,
                                        taskid = NULL,
                                        overwrite = FALSE,
                                        par = TRUE,
...
#' @export
mvn_mcar_nb_fiml_pcci_task <- function(taskid,
                                       dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_nb_fiml_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_nb_fiml_pcci_simulation <- function(dir = getwd(),
                                             all = TRUE,
                                             taskid = NULL,
                                             par = TRUE,
                                             ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_nb_fiml_pcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  fn <- "summary_medsimple_mvn_mcar_nb_fiml_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mcar_nb_fiml_bcci_task <- function(taskid,
                                       dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_nb_fiml_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_nb_fiml_bcci_simulation <- function(dir = getwd(),
                                             all = TRUE,
                                             taskid = NULL,
                                             par = TRUE,
                                             ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_nb_fiml_bcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  fn <- "summary_medsimple_mvn_mcar_nb_fiml_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mcar_nb_fiml_bcaci_task <- function(taskid,
                                        dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_nb_fiml_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_nb_fiml_bcaci_simulation <- function(dir = getwd(),
                                              all = TRUE,
                                              taskid = NULL,
                                              par = TRUE,
                                              ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_nb_fiml_bcaci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  fn <- "summary_medsimple_mvn_mcar_nb_fiml_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
