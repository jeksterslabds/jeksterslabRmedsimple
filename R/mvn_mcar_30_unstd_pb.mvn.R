...
#'   with Data Missing Completely at Random - 30%
#'
...
#' mvn_mcar_30_pb.mvn(data = data, taskid = taskid)
#' @export
mvn_mcar_30_pb.mvn <- function(data,
                               taskid) {
...
#' @family parametric functions
#' @keywords pb
#' @inheritParams mvn_mcar_30_pb.mvn
#' @inheritParams mvn_fit.ols_task
#' @export
mvn_mcar_30_pb.mvn_task <- function(taskid,
                                    dir = getwd(),
                                    overwrite = FALSE) {
...
#' @inheritParams mvn_mcar_30_pb.mvn_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_30_pb.mvn_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          overwrite = FALSE,
                                          par = TRUE,
...
#' @export
mvn_mcar_30_pb.mvn_pcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_30_pb.mvn_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_30_pb.mvn_pcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_30_pb.mvn_pcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  fn <- "summary_medsimple_mvn_mcar_30_pb.mvn_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mcar_30_pb.mvn_bcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_30_pb.mvn_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_30_pb.mvn_bcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_30_pb.mvn_bcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  fn <- "summary_medsimple_mvn_mcar_30_pb.mvn_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
