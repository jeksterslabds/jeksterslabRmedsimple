...
#' mvn_mcar_30_dat(data = data, taskid = taskid)
#' @export
mvn_mcar_30_dat <- function(data,
                            taskid) {
...
#' @family missing completely at random
#' @keywords mvn_dat
#' @inheritParams mvn_mcar_30_dat
#' @inheritParams mvn_dat_task
#' @export
mvn_mcar_30_dat_task <- function(taskid,
                                 dir = getwd(),
                                 overwrite = FALSE) {
...
#' @inheritParams mvn_mcar_30_dat_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_30_dat_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       overwrite = FALSE,
                                       par = TRUE,
