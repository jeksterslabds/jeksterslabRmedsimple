...
#' mvn_std_pbmvn(data = data, taskid = taskid, B = 200)
#' @export
mvn_std_pbmvn <- function(data,
                          taskid,
                          B = 5000) {
...
#' @family parametric functions
#' @keywords pb
#' @inheritParams mvn_std_pbmvn
#' @inheritParams mvn_fit_task
#' @export
mvn_std_pbmvn_task <- function(taskid,
                               dir = getwd(),
                               B = 5000,
                               overwrite = FALSE) {
...
#' @inheritParams mvn_std_pbmvn_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pbmvn_simulation <- function(dir = getwd(),
                                     all = TRUE,
                                     taskid = NULL,
                                     overwrite = FALSE,
                                     B = 5000,
...
#' @inheritParams pcci
#' @export
mvn_std_pbmvn_pcci_task <- function(taskid,
                                    dir = getwd(),
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_std_pbmvn_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pbmvn_pcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          alpha = c(0.001, 0.01, 0.05),
                                          par = TRUE,
...
#' @inheritParams bcci
#' @export
mvn_std_pbmvn_bcci_task <- function(taskid,
                                    dir = getwd(),
                                    alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_std_pbmvn_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pbmvn_bcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          alpha = c(0.001, 0.01, 0.05),
                                          par = TRUE,
...
#' @inheritParams bcaci
#' @export
mvn_std_pbmvn_bcaci_task <- function(taskid,
                                     dir = getwd(),
                                     alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_std_pbmvn_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_std_pbmvn_bcaci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           alpha = c(0.001, 0.01, 0.05),
                                           par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_std_pbmvn_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
