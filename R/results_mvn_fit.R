#' Monte Carlo Simulation Results - Model Fitting (Multivariate Normal)
#'
...
#'   }
#'   \item{deltamhat}{
#'     Mean of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat}{
...
#'   }
#'   \item{deltamhat_var}{
#'     Variance of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_var}{
...
#'   }
#'   \item{deltamhat_sd}{
#'     Standard deviation of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_sd}{
...
#'   }
#'   \item{deltamhat_skew}{
#'     Skewness of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_skew}{
...
#'   }
#'   \item{deltamhat_kurt}{
#'     Excess kurtosis of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_kurt}{
...
#'   }
#'   \item{deltamhat_bias}{
#'     Bias of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_bias}{
...
#'   }
#'   \item{deltamhat_mse}{
#'     Mean square error of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_mse}{
...
#'   }
#'   \item{deltamhat_rmse}{
#'     Root mean square error of estimated intercept of `m` \eqn{\left( \hat{\delta_m} \right)}.
#'   }
#'   \item{alphahat_rmse}{
