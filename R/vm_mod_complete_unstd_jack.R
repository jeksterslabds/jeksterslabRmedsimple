...
#' vm_mod_jack(data = data, taskid = taskid)
#' @export
vm_mod_jack <- function(data,
                        taskid) {
...
#' @family jackknife functions
#' @keywords jack
#' @inheritParams vm_mod_jack
#' @inheritParams mvn_fit.ols_task
#' @export
vm_mod_jack_task <- function(taskid,
                             dir = getwd(),
                             overwrite = FALSE) {
...
#' @inheritParams vm_mod_jack_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_mod_dat_simulation
#' @export
vm_mod_jack_simulation <- function(dir = getwd(),
                                   all = TRUE,
                                   taskid = NULL,
                                   overwrite = FALSE,
                                   par = TRUE,
