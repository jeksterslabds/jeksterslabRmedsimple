...
#'   with Data Missing Completely at Random - 10%
#'
...
#' data <- mvn_mcar_20_dat(data = data, taskid = taskid)
#' mvn_mcar_20_nb.del(data = data, taskid = taskid)
#' @export
mvn_mcar_20_nb.del <- function(data,
                               taskid) {
...
#' @family nonparametric functions
#' @keywords nb
#' @inheritParams mvn_mcar_20_nb.del
#' @inheritParams mvn_fit.ols_task
#' @export
mvn_mcar_20_nb.del_task <- function(taskid,
                                    dir = getwd(),
                                    overwrite = FALSE) {
...
#' @inheritParams mvn_mcar_20_nb.del_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_20_nb.del_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          overwrite = FALSE,
                                          par = TRUE,
...
#' @export
mvn_mcar_20_nb.del_pcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_20_nb.del_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_20_nb.del_pcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_20_nb.del_pcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  out <- label(
    out = out,
    method = "NBPC.DEL.MCAR.20",
    model = "Simple mediation model",
    std = FALSE,
    missing = "MCAR.20"
  )
  fn <- "summary_medsimple_mvn_mcar_20_nb.del_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mcar_20_nb.del_bcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcar_20_nb.del_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcar_20_nb.del_bcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_20_nb.del_bcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  out <- label(
    out = out,
    method = "NBBC.DEL.MCAR.20",
    model = "Simple mediation model",
    std = FALSE,
    missing = "MCAR.20"
  )
  fn <- "summary_medsimple_mvn_mcar_20_nb.del_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
