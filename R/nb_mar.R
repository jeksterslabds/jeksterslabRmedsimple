...
#' mvn_nb_mar(data = data, taskid = taskid, B = 200)
#' @export
mvn_nb_mar <- function(data,
                       taskid,
                       B = 5000) {
...
#' @family nonparametric functions
#' @keywords nb
#' @inheritParams mvn_nb_mar
#' @inheritParams mvn_fit_task
#' @export
mvn_nb_mar_task <- function(taskid,
                            dir = getwd(),
                            B = 5000,
                            overwrite = FALSE) {
...
#' @inheritParams mvn_nb_mar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_nb_mar_simulation <- function(dir = getwd(),
                                  all = TRUE,
                                  taskid = NULL,
                                  overwrite = FALSE,
                                  B = 5000,
...
#' @inheritParams pcci
#' @export
mvn_nb_mar_pcci_task <- function(taskid,
                                 dir = getwd(),
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_nb_mar_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_nb_mar_pcci_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       alpha = c(0.001, 0.01, 0.05),
                                       par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_nb_mar_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams bcci
#' @export
mvn_nb_mar_bcci_task <- function(taskid,
                                 dir = getwd(),
                                 alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_nb_mar_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_nb_mar_bcci_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       alpha = c(0.001, 0.01, 0.05),
                                       par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_nb_mar_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams bcaci
#' @export
mvn_nb_mar_bcaci_task <- function(taskid,
                                  dir = getwd(),
                                  alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_nb_mar_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_nb_mar_bcaci_simulation <- function(dir = getwd(),
                                        all = TRUE,
                                        taskid = NULL,
                                        par = TRUE,
                                        ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_nb_mar_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
