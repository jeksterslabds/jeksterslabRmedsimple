...
#'
#' @title Generate Data with MCAR from Data generated from a Multivariate Normal Distribution - Simple Mediation Model
#'
...
#' @family multivariate normal data functions
#' @keywords mvn
#' @inheritParams mvn_dat_mcar
#' @inheritParams mvn_fit_task
#' @export
mvn_dat_mcar_task <- function(taskid,
                              dir = getwd(),
                              overwrite = FALSE) {
...
#' @inheritParams mvn_dat_mcar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_dat_mcar_simulation <- function(dir = getwd(),
                                    all = TRUE,
                                    taskid = NULL,
                                    overwrite = FALSE,
                                    par = TRUE,
