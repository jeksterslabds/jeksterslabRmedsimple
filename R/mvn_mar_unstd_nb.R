...
#' mvn_mar_nb(data = data, taskid = taskid)
#' @export
mvn_mar_nb <- function(data,
                       taskid) {
...
#' @family nonparametric functions
#' @keywords mvn_complete_unstd
#' @inheritParams mvn_mar_nb
#' @inheritParams mvn_fit.ols_task
#' @export
mvn_mar_nb_task <- function(taskid,
                            dir = getwd(),
                            overwrite = FALSE) {
...
#' @inheritParams mvn_mar_nb_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mar_nb_simulation <- function(dir = getwd(),
                                  all = TRUE,
                                  taskid = NULL,
                                  overwrite = FALSE,
                                  par = TRUE,
...
#' @export
mvn_mar_nb_pcci_task <- function(taskid,
                                 dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mar_nb_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mar_nb_pcci_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       par = TRUE,
                                       ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_mar_nb_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mar_nb_bcci_task <- function(taskid,
                                 dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mar_nb_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mar_nb_bcci_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       par = TRUE,
                                       ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_mar_nb_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mar_nb_bcaci_task <- function(taskid,
                                  dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords mvn_complete_unstd
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mar_nb_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mar_nb_bcaci_simulation <- function(dir = getwd(),
                                        all = TRUE,
                                        taskid = NULL,
                                        par = TRUE,
                                        ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_mar_nb_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
