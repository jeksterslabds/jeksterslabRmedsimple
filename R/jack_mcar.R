...
#' mvn_jack_mcar(data = data, taskid = taskid)
#' @export
mvn_jack_mcar <- function(data,
                          taskid) {
...
#' @family jackknife functions
#' @keywords jack
#' @inheritParams mvn_jack_mcar
#' @inheritParams mvn_fit_task
#' @export
mvn_jack_mcar_task <- function(taskid,
                               dir = getwd(),
                               overwrite = FALSE) {
...
#' @inheritParams mvn_jack_mcar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_jack_mcar_simulation <- function(dir = getwd(),
                                     all = TRUE,
                                     taskid = NULL,
                                     overwrite = FALSE,
                                     par = TRUE,
