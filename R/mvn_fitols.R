...
#' mvn_fitols(data = data, taskid = taskid)
#' @export
mvn_fitols <- function(data,
                       taskid) {
...
#' @family model fit functions
#' @keywords fit
#' @inheritParams mvn_fitols
#' @inheritParams mvn_dat_task
#' @export
mvn_fitols_task <- function(taskid,
                            dir = getwd(),
                            overwrite = FALSE) {
...
#' @inheritParams mvn_fitols_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_fitols_simulation <- function(dir = getwd(),
                                  all = TRUE,
                                  taskid = NULL,
                                  overwrite = FALSE,
                                  par = TRUE,
...
#' @export
mvn_fitols_task_summary <- function(taskid,
                                    dir = getwd()) {
  # for socks to load package in the namespace
  require(
    "jeksterslabRmedsimple"
...
#' @family model fit functions
#' @keywords fit
#' @inheritParams mvn_fitols_simulation
#' @inheritParams mvn_dat_simulation
#' @export
mvn_fitols_simulation_summary <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          par = TRUE,
                                          ncores = NULL,
  ...
  saveRDS(
    ...
    file = file.path(
      dir,
      "summary_medsimple_mvn_fitols.Rds"
    )
  )
}
