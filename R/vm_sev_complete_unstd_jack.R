...
#' vm_sev_jack(data = data, taskid = taskid)
#' @export
vm_sev_jack <- function(data,
                        taskid) {
...
#' @family jackknife functions
#' @keywords jack
#' @inheritParams vm_sev_jack
#' @inheritParams mvn_fit.ols_task
#' @export
vm_sev_jack_task <- function(taskid,
                             dir = getwd(),
                             overwrite = FALSE) {
...
#' @inheritParams vm_sev_jack_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_sev_dat_simulation
#' @export
vm_sev_jack_simulation <- function(dir = getwd(),
                                   all = TRUE,
                                   taskid = NULL,
                                   overwrite = FALSE,
                                   par = TRUE,
