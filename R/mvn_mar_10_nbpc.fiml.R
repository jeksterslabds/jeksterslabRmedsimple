...
#' @export
mvn_mar_10_nbpc.fiml_task <- function(taskid,
                                      dir = getwd(),
                                      overwrite = FALSE) {
  ...
  fn <- paste0(
    "medsimple_mvn_mar_10_nbpc.fiml_",
    sprintf(
      "%05.0f",
      taskid
    ),
...
#' @export
mvn_mar_10_nbpc.fiml_simulation <- function(dir = getwd(),
                                            all = TRUE,
                                            taskid = NULL,
                                            overwrite = FALSE,
                                            par = TRUE,
...
mvn_mar_10_nb.fiml_pcci_simulation <- function(dir = getwd(),
  ...
  out <- label(
    out = out,
    method = "NBPC.FIML.MAR.10",
    model = "Simple Mediation Model",
    std = FALSE,
    missing = "MAR.10"
  )
  fn <- "summary_medsimple_mvn_mar_10_nb.fiml_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
