...
#'   for Data Generated from a Multivariate Normal Distribution with MAR
#'
...
#' mvn_mcmvn_mar(data = data, taskid = taskid, R = 200)
#' @export
mvn_mcmvn_mar <- function(data,
                          taskid,
                          R = 5000) {
...
#' taskid <- 1
#' data <- mvn_dat(taskid = taskid)
#' mvn_mct_mar(data = data, taskid = taskid, R = 200)
#' @export
mvn_mct_mar <- function(data,
                        taskid,
                        R = 5000) {
  paramsmvn <- useparamsmvn(taskid = taskid)
  fit <- .fitfiml(
...
#'   for Data Generated from a Multivariate Normal Distribution with MAR (Single Task)
#'
#' @family monte carlo method functions
#' @keywords mc
#' @inheritParams mvn_mcmvn_mar
#' @inheritParams mvn_fit_task
#' @export
mvn_mcmvn_mar_task <- function(taskid,
                               R = 5000,
                               dir = getwd(),
                               overwrite = FALSE) {
...
#'
#' @title Monte Carlo Method for Indirect Effect in a Simple Mediation Model Assuming Multivariate Normal Distribution
#'   for Data Generated from a Multivariate Normal Distribution with MAR (Simulation)
#'
#' @family monte carlo method functions
#' @keywords mc
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcmvn_mar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcmvn_mar_simulation <- function(dir = getwd(),
                                     all = TRUE,
                                     taskid = NULL,
                                     overwrite = FALSE,
                                     R = 5000,
...
#' @family monte carlo method functions
#' @keywords mc
#' @inheritParams mvn_mct_mar
#' @inheritParams mvn_fit_task
#' @export
mvn_mct_mar_task <- function(taskid,
                             R = 5000,
                             dir = getwd(),
                             overwrite = FALSE) {
  # for socks to load package in the namespace
...
#' @keywords mc
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mct_mar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mct_mar_simulation <- function(dir = getwd(),
                                   all = TRUE,
                                   taskid = NULL,
                                   overwrite = FALSE,
                                   R = 5000,
...
#' @inheritParams pcci
#' @export
mvn_mcmvn_mar_pcci_task <- function(taskid,
                                    dir = getwd(),
...
#' @keywords mc
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mcmvn_mar_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mcmvn_mar_pcci_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          alpha = c(0.001, 0.01, 0.05),
                                          par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_mcmvn_mar_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams pcci
#' @export
mvn_mct_mar_pcci_task <- function(taskid,
                                  dir = getwd(),
                                  alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords mc
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mct_mar_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mct_mar_pcci_simulation <- function(dir = getwd(),
                                        all = TRUE,
                                        taskid = NULL,
                                        alpha = c(0.001, 0.01, 0.05),
                                        par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_mct_mar_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
