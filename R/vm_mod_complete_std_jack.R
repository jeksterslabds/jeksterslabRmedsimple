...
#'
#' @title Jackknife Estimates of Indirect Effect in a Simple Mediation Model for Data Generated Using the Vale and Maurelli (1983) Approach (Skewness = 2, Kurtosis = 7)
#'
...
#' vm_mod_std_jack(data = data, taskid = taskid)
#' @export
vm_mod_std_jack <- function(data,
                            taskid) {
...
#' @author Ivan Jacob Agaloos Pesigan
#'
#' @title Jackknife Estimates of Indirect Effect in a Simple Mediation Model for Data Generated Using the Vale and Maurelli (1983) Approach (Skewness = 2, Kurtosis = 7) (Single Task)
#'
#' @family jackknife functions
#' @keywords jack
#' @inheritParams vm_mod_std_jack
#' @inheritParams mvn_fit.ols_task
#' @export
vm_mod_std_jack_task <- function(taskid,
                                 dir = getwd(),
                                 overwrite = FALSE) {
...
#' @author Ivan Jacob Agaloos Pesigan
#'
#' @title Jackknife Estimates of Indirect Effect in a Simple Mediation Model for Data Generated Using the Vale and Maurelli (1983) Approach (Skewness = 2, Kurtosis = 7) (Simulation)
#'
#' @family jackknife functions
#' @keywords jack
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams vm_mod_std_jack_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams vm_mod_dat_simulation
#' @export
vm_mod_std_jack_simulation <- function(dir = getwd(),
                                       all = TRUE,
                                       taskid = NULL,
                                       overwrite = FALSE,
                                       par = TRUE,
