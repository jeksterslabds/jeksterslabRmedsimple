...
#' mvn_pbmvn_mcar(data = data, taskid = taskid, B = 200)
#' @export
mvn_pbmvn_mcar <- function(data,
                           taskid,
                           B = 5000) {
...
#' @family parametric functions
#' @keywords pb
#' @inheritParams mvn_pbmvn_mcar
#' @inheritParams mvn_fit_task
#' @export
mvn_pbmvn_mcar_task <- function(taskid,
                                dir = getwd(),
                                B = 5000,
                                overwrite = FALSE) {
...
#' @inheritParams mvn_pbmvn_mcar_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_pbmvn_mcar_simulation <- function(dir = getwd(),
                                      all = TRUE,
                                      taskid = NULL,
                                      overwrite = FALSE,
                                      B = 5000,
...
#' @inheritParams pcci
#' @export
mvn_pbmvn_mcar_pcci_task <- function(taskid,
                                     dir = getwd(),
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_pbmvn_mcar_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_pbmvn_mcar_pcci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           alpha = c(0.001, 0.01, 0.05),
                                           par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_pbmvn_mcar_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams bcci
#' @export
mvn_pbmvn_mcar_bcci_task <- function(taskid,
                                     dir = getwd(),
                                     alpha = c(0.001, 0.01, 0.05)) {
  # for socks to load package in the namespace
  requireNamespace(
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_pbmvn_mcar_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_pbmvn_mcar_bcci_simulation <- function(dir = getwd(),
                                           all = TRUE,
                                           taskid = NULL,
                                           alpha = c(0.001, 0.01, 0.05),
                                           par = TRUE,
  ...
  fn <- "summary_medsimple_mvn_pbmvn_mcar_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams bcaci
#' @export
mvn_pbmvn_mcar_bcaci_task <- function(taskid,
                                      dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords pb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_pbmvn_mcar_bcaci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_pbmvn_mcar_bcaci_simulation <- function(dir = getwd(),
                                            all = TRUE,
                                            taskid = NULL,
                                            par = TRUE,
                                            ncores = NULL,
  ...
  fn <- "summary_medsimple_mvn_pbmvn_mcar_bcaci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
