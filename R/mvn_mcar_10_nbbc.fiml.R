...
#' @export
mvn_mcar_10_nbbc.fiml_task <- function(taskid,
                                       dir = getwd(),
                                       overwrite = FALSE) {
  ...
  fn <- paste0(
    "medsimple_mvn_mcar_10_nbbc.fiml_",
    sprintf(
      "%05.0f",
      taskid
    ),
...
#' @export
mvn_mcar_10_nbbc.fiml_simulation <- function(dir = getwd(),
                                             all = TRUE,
                                             taskid = NULL,
                                             overwrite = FALSE,
                                             par = TRUE,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mcar_10_nbbc.fiml_task,
      dir = dir,
      overwrite = overwrite,
      par = par,
      ncores = ncores,
...
mvn_mcar_10_nb.fiml_pcci_simulation <- function(dir = getwd(),
  ...
  fn <- "summary_medsimple_mvn_mcar_10_nbbc.fiml.Rds"
  saveRDS(
    object = out,
    file = fn
  )
