...
#' data <- mvn_mnar_10_dat(data = data, taskid = taskid)
#' mvn_mnar_10_nb.del(data = data, taskid = taskid)
#' @export
mvn_mnar_10_nb.del <- function(data,
                               taskid) {
...
#' @family nonparametric functions
#' @keywords nb
#' @inheritParams mvn_mnar_10_nb.del
#' @inheritParams mvn_fit.ols_task
#' @export
mvn_mnar_10_nb.del_task <- function(taskid,
                                    dir = getwd(),
                                    overwrite = FALSE) {
...
#' @inheritParams mvn_mnar_10_nb.del_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mnar_10_nb.del_simulation <- function(dir = getwd(),
                                          all = TRUE,
                                          taskid = NULL,
                                          overwrite = FALSE,
                                          par = TRUE,
...
#' @export
mvn_mnar_10_nb.del_pcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mnar_10_nb.del_pcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mnar_10_nb.del_pcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mnar_10_nb.del_pcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  out <- label(
    out = out,
    method = "NBPC.DEL.MNAR.10",
    model = "Simple mediation model",
    std = FALSE,
    missing = "MNAR.10"
  )
  fn <- "summary_medsimple_mvn_mnar_10_nb.del_pcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
...
#' @inheritParams mvn_dat_task
#' @export
mvn_mnar_10_nb.del_bcci_task <- function(taskid,
                                         dir = getwd()) {
  # for socks to load package in the namespace
  requireNamespace(
    "jeksterslabRmedsimple",
...
#' @keywords nb
#' @importFrom jeksterslabRpar par_lapply
#' @inheritParams mvn_mnar_10_nb.del_bcci_task
#' @inheritParams jeksterslabRpar::par_lapply
#' @inheritParams mvn_dat_simulation
#' @export
mvn_mnar_10_nb.del_bcci_simulation <- function(dir = getwd(),
                                               all = TRUE,
                                               taskid = NULL,
                                               par = TRUE,
                                               ncores = NULL,
  ...
  out <- invisible(
    par_lapply(
      X = taskid,
      FUN = mvn_mnar_10_nb.del_bcci_task,
      dir = dir,
      par = par,
      ncores = ncores,
      blas_threads = blas_threads,
  ...
  out <- label(
    out = out,
    method = "NBBC.DEL.MNAR.10",
    model = "Simple mediation model",
    std = FALSE,
    missing = "MNAR.10"
  )
  fn <- "summary_medsimple_mvn_mnar_10_nb.del_bcci.Rds"
  saveRDS(
    object = out,
    file = fn
  )
